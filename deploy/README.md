...
```bash
sudo ufw allow 8080/tcp   # or firewall-cmd --add-port=8080/tcp --permanent && --reload
curl http://192.168.0.82:8080/health
```

The DEM server then calls `http://192.168.0.82:8080/...` directly - no proxy needed unless it's
